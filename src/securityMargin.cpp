...
void SecurityMargin::buildSelected()
{
    ...
    case 1:
        ...
        buildArraysSquare2(0);
        buildArraysSquare2(1);
        ROS_INFO("Finished");
        break;
    case 2:
...
void SecurityMargin::setParams(ros::NodeHandle *n)
{
    ...
    aproach_man_sub = nh->subscribe<std_msgs::Bool>("/trajectory_tracker/aproach_manoeuvre", 1, &SecurityMargin::aproachManCb, this);
    dist2goal_sub = nh->subscribe<std_msgs::Float32>("/dist2goal", 1, &SecurityMargin::dist2GoalCb, this);

    goal_reached_sub = nh->subscribe<std_msgs::Bool>("/trajectory_tracker/local_goal_reached", 1, &SecurityMargin::goalReachedCb, this);
    ...
    case 0:
        ...
        if (!onlyFront)
        {
            ...
            laser2_sub = nh->subscribe<sensor_msgs::LaserScan>(laser2_topic.c_str(), 1, &SecurityMargin::laser2Callback, this);
            laser2Got = false;
        }
        else
        {
    ...
    laser1_sub = nh->subscribe<sensor_msgs::LaserScan>(laser1_topic.c_str(), 1, &SecurityMargin::laser1Callback, this);
