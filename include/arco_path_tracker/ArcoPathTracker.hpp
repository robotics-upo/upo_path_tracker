...
#ifndef ARCOPATHTRACKER_H_
#define ARCOPATHTRACKER_H_
...
#include <upo_path_tracker/ArcoPathTrackerConfig.h>
...
public:
   ...
   **/
  ArcoPathTracker(tf2_ros::Buffer *tfBuffer_);
  ...
  void dynReconfCb(upo_path_tracker::ArcoPathTrackerConfig &config, uint32_t level);
  /**
...
private:
  ...
  ros::Publisher twist_pub, moving_state_pub, dist2goal_pub, speed_marker_pub, approach_man_pub,
